...
function initSprites(img) {
	...
	s_ghost = [
		new Sprite(img, 158, 114, 15, 17),
		new Sprite(img, 158, 131, 15, 17),
		new Sprite(img, 158, 149, 15, 17)
	];
	
	s_bg = new Sprite(img,   0, 0, 138, 114);
	s_bg.color = "#020419"; // save background color
	s_fg = new Sprite(img, 132, 0, 112,  16);
	
	s_pipeNorth = new Sprite(img, 245, 0, 28, 191);
	s_pipeSouth = new Sprite(img, 274, 0, 28, 191);
	
	s_text = {
		FlappyGhost: new Sprite(img, 59, 114, 96, 22),
	...
	s_buttons = {
		...
		Ok:    new Sprite(img, 158, 192, 42, 13),
		Start: new Sprite(img, 159, 191, 40, 14)
	}

	s_score  = new Sprite(img, 194,  55, 50, 59);
	s_splash = new Sprite(img,   23, 134,  15, 29);

	s_numberS = new Sprite(img, 0, 179, 6,  8);
	s_numberB = new Sprite(img, 0, 188, 7, 10);

	s_stars = new Sprite(img, 0, 213, 127, 105);
